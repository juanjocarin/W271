...
```{r Question4-1-4, echo = F}
```

```{r Question4-1-5, echo = F}
```

```{r Question4-1-6, echo = F}
```

```{r Question4-1-7, echo = F}
```

```{r Question4-1-8, echo = F}
```

```{r Question4-1-9, echo = F}
```

```{r Question4-1-10, echo = F}
```

```{r Question4-1-11, echo = F}
```

```{r Question4-1-12, echo = F}
```

```{r Question4-1-13, echo = F}
```

```{r Question4-1-14, echo = F}
```

```{r Question4-1-15, echo = F}
```
...
```{r Question4-2-3, echo = F}
```

```{r Question4-2-4, echo = F}
```

```{r Question4-2-5, echo = F}
```

```{r Question4-2-6, echo = F}
```

```{r Question4-2-7, echo = F}
```

```{r Question4-2-8, echo = F}
```

```{r Question4-2-9, echo = F}
```

```{r Question4-2-10, echo = F}
```

```{r Question4-2-11, echo = F}
```

```{r Question4-2-12, echo = F}
```

```{r Question4-2-13, echo = F}
```

```{r Question4-2-14, echo = F}
```

```{r Question4-2-15, echo = F}
```

```{r Question4-2-16, echo = F}
```

```{r Question4-2-17, echo = F}
```

```{r Question4-2-18, echo = F}
```

```{r Question4-2-19, echo = F}
```

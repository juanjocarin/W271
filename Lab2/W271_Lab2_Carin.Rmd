...
```{r Question6-1, fig.width = 6, fig.height = 4.5, fig.cap = "Histogram of all non-categorical variables in the dataset"}
```

```{r Question6-2, fig.width = 6, fig.height = 6, fig.cap = "Scatterplot matrix of a sample of the dataset, after omitting missin values"}
```

```{r Question6-3, fig.width = 6, fig.height = 6, fig.cap = "Scatterplot matrix of a sample of the dataset, after omitting missin values (with correlations)"}
```

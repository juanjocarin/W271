...
The use of robust standard error calculations or weighted least squares regression may be able to aid in estimating variance under the heteroskedasticity case; however they may necessitate other assumption to be met. Alternatively a transform (ie log or square root) could be applied to the variable to try and address the heteroskedasticity in running the OLS regression. 

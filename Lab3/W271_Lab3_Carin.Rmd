...
It contains `r dim(GW)[1]` observations of a numeric variables (`data.science`, shortened to `DS`), with no missing values, from 
...
```{r P3-timeplot, echo = FALSE, fig.width = 6, fig.height = 3.75, fig.cap = "Level of interest in global warming in the news from 2004 to 2015"}
```

```{r P3-whole_and_last, fig.width = 6, fig.height = 3.75, fig.cap = "Level of interest in global warming in the news from 2004 to 2015"}
```

```{r P3-whole_and_last_2, echo = FALSE, fig.width = 6, fig.height = 4.5, fig.cap = "xxxx"}
```

```{r P3-whole_and_last_3, echo = FALSE, fig.width = 6, fig.height = 4.5, fig.cap = "xxxx"}
```

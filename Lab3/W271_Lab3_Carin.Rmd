...
Thus, we can use this enhanced model to get narrower confidence intervals of the previous forecasts.
...
The figure below shows the previous 80% and 95% confidence intervals (without applying the GARCH model), and (in a darker shade) the 95% confidence intervals applying a GARCH(1,1) model to the residuals of the ARIMA(0,1,0), which are much narrower.

...
Not only the histogram but also the quantiles of `cigs` tell us that the vast majority of women in this sample did
not smoke while pregnant. To better assess the shape of the distribution, it is more useful to look at the
distribution among smokers.
...
using the non-transformed variable seems more appropriate.

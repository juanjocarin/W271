...
```{r Question3-3-2, echo = c(1:2),fig.cap = "Histogram of birth weight (in ounces), using `ggplot` and bin width = 5", fig.width = 3, fig.height = 2.25}
```

\pagebreak

```{r Question3-3-3, echo = FALSE, fig.cap = "Histogram of birth weight (in ounces), using `ggplot` and bin width = 10", fig.width = 3, fig.height = 2.25}
```

```{r Question3-3-4, echo = FALSE, fig.cap = "Histogram of birth weight (in ounces), using `ggplot` and bin width = 20", fig.width = 3, fig.height = 2.25}
```
...
```{r Question4-3-2, echo = c(1:3), fig.cap = "Histogram of cigarettes smoked each day by the mother while pregnant, bin width = 1", fig.width = 3, fig.height = 2.25}
```

```{r Question4-3-3, echo = FALSE, fig.cap = "Histogram of cigarettes smoked each day by the mother while pregnant, bin width = 5", fig.width = 3, fig.height = 2.25}
```

\pagebreak

```{r Question4-3-4, echo = FALSE, fig.cap = "Histogram of cigarettes smoked each day by the mother while pregnant, bin width = 10", fig.width = 3, fig.height = 2.25}
```
...
There seems to be a negative relationship between the number of cigarettes smoked each day by the mother while pregnant and the birth weight of the child (i.e., the more a mother smokes, the less her child will weigh), but since `cigs` only takes a few values (mainly 0) I don't think it explains a lot of the variation in `bwght`.
...
```{r Question7-3-2, echo = -c(1:2), fig.cap = "Histogram of family income (in thousands of dollars), bin width = 2", fig.width = 3, fig.height = 2.25}
```

```{r Question7-3-3, echo = FALSE, fig.cap = "Histogram of family income (in thousands of dollars), bin width = 5", fig.width = 3, fig.height = 2.25}
```

\pagebreak

```{r Question7-3-4, echo = FALSE, fig.cap = "Histogram of family income (in thousands of dollars), bin width = 10", fig.width = 3, fig.height = 2.25}
```

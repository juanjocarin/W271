...
4. **Produce  a scatterplot matrix of bwght, cigs and faminc. **

```{r Question7-part4, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Scatterplot matrix of bwght, cigs and faminc", fig.width = 6, fig.height = 4.5}
```

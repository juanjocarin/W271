...
read_chunk('code/W271_HW6_MHSONG.R')
opts_chunk$set(message = FALSE, warning = FALSE)
opts_chunk$set(fig.width = 4, fig.height = 3)
# Set path to data here (don't use setwd() inside a chunk!!!)
opts_knit$set(root.dir = "C:/Users/songminghu/Documents/GitHub/W271/HW6/data")
```
...
```{r Question2-2, echo = T, comment=NA}
```
...
```{r Question4-6-1, echo = FALSE, fig.align='center', fig.width = 5, fig.height = 4}
```
...
```{r Question4-6-2, echo = FALSE, fig.align='center', fig.width = 5, fig.height = 4}
```
...
```{r Question4-6-3, echo = FALSE, fig.align='center', fig.width = 5, fig.height = 4}
```
...
```{r Question4-6-4, echo = FALSE, fig.align='center', fig.width = 5, fig.height = 4}
```
...
```{r Question4-6-5, echo = FALSE, fig.align='center', fig.width = 5, fig.height = 4}
```
...
```{r Question4-6-6, echo = FALSE, fig.align='center', fig.width = 5, fig.height = 4}
```

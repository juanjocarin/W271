...
```{r Question6-part1-a, echo=FALSE, message = FALSE, warning = FALSE, fig.cap = "Contour plot and 3D plot of $X, Y, Z$", fig.width = 6, fig.height = 4.5}
```
...
```{r Question6-part1-b, echo=FALSE, message = FALSE, warning = FALSE, fig.cap = "Region of the $X-Y$ plane for which $Z<z$ where $z=0.8$", fig.width = 6, fig.height = 4.5}
```
...
```{r Question7-part1-a, echo=FALSE, message = FALSE, warning = FALSE}
```
...
```{r Question7-part1-b, echo=TRUE, message = FALSE, warning = FALSE}
```
...
```{r Question12-partiii, echo=TRUE, message = FALSE, warning = FALSE}
```
...
```{r Question13-partiii-a, echo=TRUE, message = FALSE, warning = FALSE}
```
...
```{r Question13-partiii-b, echo=FALSE, message = FALSE, warning = FALSE}
```

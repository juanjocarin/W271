...
Apart from showing that the time series is **not mean stationary** (the mean depends on time, with an increasing trend), Figure 2 in the previous page shows that the time is also **not variance stationary:** the variance is not constant but changes with time (increasing in the last years, especially the last 7); see Table 2 and Figure 4 in the next page.

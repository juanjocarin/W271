...
read_chunk('code/W271_HW8_Carin-Davis-Levato-Song.R')
...
```{r ex1-models_analysis-4, echo = FALSE, fig.width=5, fig.height=3.75, fig.cap = "AIC of the models depending on the order (p and q)"}
```

```{r ex1-models_analysis-5, echo = FALSE, fig.width=5, fig.height=3.75, fig.cap = "AIC of the ARMA models depending on the order (p and q)"}
```

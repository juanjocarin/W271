...
The diagnostic plots (below) show that all the CLM assumptions are met to some extent (the residuals are not totally homoskedastic, but that might be due to a lack of observations for the most extreme values):

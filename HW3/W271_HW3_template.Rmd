...
read_chunk('code/W271_HW3_template.R')
...
$$\mathbf{log(wage) = \beta_0 + \beta_1jc + \beta_2univ + \beta_3exper + \beta_4black + \beta_5hispanic + \beta_6AA + \beta_7BA + \beta_8exper \cdot black+e}$$
